...
class TrainingCoordinator:
    def __init__(  # noqa
        ...
        # print(holder.unpartitioned_embeddings)
        # print(holder.partitioned_embeddings)
        ...
        print(model)
        # print(model.lhs_embs)
        # print(type(model.lhs_embs))
        ...
        if pre_embeddings is not None:
            self.holder.partitioned_embeddings = pre_embeddings
    ...
    def train(self) -> None:
        ...
        # print(holder.unpartitioned_embeddings)
        # print(holder.partitioned_embeddings)
        # print(holder.partitioned_embeddings.keys())
        # print(holder.partitioned_embeddings[('C', 0)].size())
        # print(holder.partitioned_embeddings[('P', 0)].size())
        # print(holder.partitioned_embeddings[('G', 0)].size())
