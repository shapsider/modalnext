...
mdata = mu.read_h5mu("../dataset/ma2020/ma2020_preprocessed.h5mu.gz")
print(mdata)
...
workdir = f"../dataset/ma2020/gnn_result_processed"
...
# 构造初始embedding
pre_embeddings = {}
mdata = mu.read_h5mu("../dataset/ma2020/inmf/nmf.h5mu.gz")
