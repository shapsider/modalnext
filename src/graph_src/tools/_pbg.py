...
sys.path.append("/aaa/gelseywang/buddy1/lukatang/PairedIntegration/inmf_gnn_spatial/simba_src/tools")
...
def pbg_train(dirname=None,
    ...
    train(train_config, subprocess_init=subprocess_init, pre_embeddings=pre_embeddings)
    print("Finished")
